...
public class ContentBrowseActivity extends BaseActivity implements ContentBrowseFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String embedString = "<iframe width=\"360\" height=\"215\" src=\"https://www.youtube.com/embed/6WB1KpmSXWk\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>";
        String descriptionText = "Build A Fire TV App in 5 Minutes";
        String text;
        text = "<html><body dir=\"rtl\"; style=\"text-align:justify;\">";//use for justify your text
        text += descriptionText + embedString ;
        text += "</body></html>";

        webView= (WebView) findViewById(R.id.wb);
        webView.getSettings().setJavaScriptEnabled(true);
        webView.setWebViewClient(new WebViewClient());
        //webView.loadData(ypath);
